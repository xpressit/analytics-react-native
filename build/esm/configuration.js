...
export var configure = function (writeKey, _a) {
    var _b = _a.flushAt, flushAt = _b === void 0 ? 20 : _b, _c = _a.debug, debug = _c === void 0 ? false : _c, _d = _a.recordScreenViews, recordScreenViews = _d === void 0 ? false : _d, _e = _a.trackAppLifecycleEvents, trackAppLifecycleEvents = _e === void 0 ? false : _e, _f = _a.trackAttributionData, trackAttributionData = _f === void 0 ? false : _f, _g = _a.using, using = _g === void 0 ? [] : _g, _h = _a.defaultProjectSettings, defaultProjectSettings = _h === void 0 ? {} : _h, proxy = _a.proxy, _j = _a.ios, ios = _j === void 0 ? {} : _j, _k = _a.android, android = _k === void 0 ? {} : _k;
